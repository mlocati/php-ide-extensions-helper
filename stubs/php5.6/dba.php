 ...
 */
function dba_fetch($key, $handle, $handle = null)
{
}
 ...
 */
function dba_open($path, $mode, $handler = null, ...$handler_parameters)
{
}
 ...
 */
function dba_popen($path, $mode, $handler = null, ...$handler_parameters)
{
}
