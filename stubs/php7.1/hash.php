...
// - parsed on POSIX with PHP 7.1.15 (extension version 1.0)
// - parsed on Windows with PHP 7.1.15 (extension version 1.0)
 ...
 */
function hash_hkdf($ikm, $algo, $length = null, $string = null, $salt = null): string
{
}
