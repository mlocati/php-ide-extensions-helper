...
interface SessionUpdateTimestampHandlerInterface
{
     ...
     * @param string $val
     *
     * @return bool Returns <code>TRUE</code> if the timestamp was updated, <code>FALSE</code> otherwise.
     *
     * @since PHP 7
     *
     ...
     * @param string $key
     *
     * @return bool Returns <code>TRUE</code> for valid ID, <code>FALSE</code> otherwise.
     *
     * @since PHP 7
     *
 ...
 *
 * @param string $prefix If <code>prefix</code> is specified, new session id
 * is prefixed by <code>prefix</code>. Not all
 * characters are allowed within the session id. Characters in
 * the range <code>a-z A-Z 0-9 , (comma) and -
 * (minus)</code> are allowed.
 *
 * @return string <code>session_create_id</code> returns new collision free
 ...
 *
 * @return int <code>session_gc</code> returns number of deleted session
 * data for success, <code>FALSE</code> for failure.
 ...
 */
function session_set_save_handler(callable $open, callable $close = null, callable $read = null, callable $write = null, callable $destroy = null, callable $gc = null, callable $create_sid = null, callable $validate_sid = null, callable $update_timestamp = null): bool
{
}
 ...
 *
 * @param array|null $options If provided, this is an associative array of options that will override
 * the currently set
 * session configuration directives.
 * The keys should not include the <code>session.</code> prefix.
 *
 ...
 */
function session_start(array $options = /* array() */ null): bool
{
}
