...
final class Closure
{
     ...
     */
    public static function bind(Closure $closure, $newthis, $newscope = "static"): Closure
    {
    }
     ...
     */
    public function bindTo($newthis, $newscope = "static"): Closure
    {
    }
     ...
     *
     * @param mixed $newthis The <code>object</code> to bind the closure to for the duration of the
     * call.
