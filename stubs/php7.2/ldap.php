 ...
 *
 * @param resource $link An LDAP link identifier, returned by <code>ldap_connect</code>.
 * @param string $reqoid The extended operation request OID. You may use one of <code>LDAP_EXOP_START_TLS</code>, <code>LDAP_EXOP_MODIFY_PASSWD</code>, <code>LDAP_EXOP_REFRESH</code>, <code>LDAP_EXOP_WHO_AM_I</code>, <code>LDAP_EXOP_TURN</code>, or a string with the OID of the operation you want to send.
 * @param string $reqdata The extended operation request data. May be NULL for some operations like <code>LDAP_EXOP_WHO_AM_I</code>, may also need to be BER encoded.
 * @param array $servercontrols Unused as of PHP 7.2.
 ...
 *
 * @return mixed When used with <code>retdata</code>, returns <code>TRUE</code> on success or <code>FALSE</code> on error.
 * When used without <code>retdata</code>, returns a result identifier or <code>FALSE</code> on error.
 *
 * @since PHP 7 >= 7.2.0
 *
 ...
 *
 * @return mixed Returns the generated password if <code>newpw</code> is empty or omitted.
 * Otherwise returns <code>TRUE</code> on success and <code>FALSE</code> on failure.
 *
 * @since PHP 7 >= 7.2.0
 *
 * @link http://www.php.net/manual/en/function.ldap-exop-passwd.php
 */
function ldap_exop_passwd($link, string $user, string $oldpw, string $newpw)
{
}
 ...
 * @param resource $link An LDAP link identifier, returned by <code>ldap_connect</code>.
 *
 * @return string The data returned by the server, or <code>FALSE</code> on error.
 *
 * @since PHP 7 >= 7.2.0
 *
 ...
 *
 * @param resource $link An LDAP link identifier, returned by <code>ldap_connect</code>.
 * @param resource $result An LDAP result resource, returned by <code>ldap_exop</code>.
