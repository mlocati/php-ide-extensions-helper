...
class DateTime implements DateTimeInterface
{
     ...
     */
    public static function createFromFormat($format, $time, DateTimeZone $object = null): DateTime
    {
    }
...
class DateTimeImmutable implements DateTimeInterface
{
     ...
     */
    public static function createFromFormat($format, $time, DateTimeZone $object = null): DateTimeImmutable
    {
    }
     ...
     */
    public function setTime($hour, $minute, $second = null, $microseconds = null): DateTimeImmutable
    {
    }
...
class DateTimeZone
{
     ...
     */
    public function getOffset($object): int
    {
    }
 ...
 * @link http://www.php.net/manual/en/datetime.createfromformat.php
 */
function date_create_from_format($format, $time, DateTimeZone $object = null): DateTime
{
}
 ...
 * @link http://www.php.net/manual/en/datetimeimmutable.createfromformat.php
 */
function date_create_immutable_from_format($format, $time, DateTimeZone $object = null): DateTimeImmutable
{
}
 ...
 * @link http://www.php.net/manual/en/datetime.settime.php
 */
function date_time_set($object, $hour, $minute, $second = null, $microseconds = null): DateTime
{
}
