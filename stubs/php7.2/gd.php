 ...
 */
function imagebmp($im, $to = null, $compressed = null): bool
{
}
 ...
 */
function imageopenpolygon($im, $points, $num_pos, $col): bool
{
}
 ...
 *
 * @param mixed $im
 * @param mixed|null $res_x
 * @param mixed|null $res_y
 *
 * @return mixed
 *
 * @since PHP 7 >= 7.2.0
 ...
 */
function imagesetclip($im, $x1, $y1, $x2, $y2): bool
{
}
