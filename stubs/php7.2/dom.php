...
// - parsed on POSIX with PHP 7.2.3 (extension version 20031129)
// - parsed on Windows with PHP 7.2.4 (extension version 20031129)
 ...
 */
class DOMNamedNodeMap implements Countable, Traversable
{
    /**
     ...
     */
    public function getNamedItemNS(string $namespaceURI = null, string $localName = null): DOMNode
    {
    }
 ...
 */
class DOMNodeList implements Countable, Traversable
{
    /**
     ...
     *
     * @return int Returns number of nodes in the list or <code>FALSE</code> on failure.
     *
