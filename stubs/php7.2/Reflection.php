...
class ReflectionClass implements Reflector
{
     ...
     *
     * @return bool Returns <code>TRUE</code> if this class is iterable (can be used inside foreach),
...
abstract class ReflectionFunctionAbstract implements Reflector
{
     ...
     *
     * @return object Returns <code>$this</code> pointer.
     * Returns <code>NULL</code> in case of an error.
     *
     * @since PHP 5 >= 5.4.0, PHP 7
     *
...
class ReflectionGenerator
{
     ...
     *
     * @return object Returns the <code>$this</code> value, or <code>NULL</code> if the generator was
...
class ReflectionMethod extends ReflectionFunctionAbstract
{
     ...
     */
    public function invoke(object $object, $parameter)
    {
    }
...
class ReflectionProperty implements Reflector
{
     ...
     * Gets value
     *
     * @param object $object If the property is non-static an object must be provided to fetch the
     ...
     */
    public function setValue(object $object, $value = null): void
    {
    }
}
