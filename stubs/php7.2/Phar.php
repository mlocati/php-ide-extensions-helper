...
class Phar extends RecursiveDirectoryIterator implements ArrayAccess, Countable
{
     ...
     */
    public function addEmptyDir(string $dirname = null): void
    {
    }
     ...
     */
    public function addFromString(string $localname, string $contents = null): void
    {
    }
     ...
     *
     * @return object Returns a <code>Phar</code> object.
     *
     * @since PHP 5 >= 5.3.0, PHP 7, PECL phar >= 2.0.0
     *
     ...
     * in their filename.
     *
     * @return object A <code>Phar</code> object is returned.
     *
     * @since PHP 5 >= 5.3.0, PHP 7, PECL phar >= 2.0.0
     *
...
class PharData extends RecursiveDirectoryIterator implements ArrayAccess, Countable
{
     ...
     *
     * @return object A <code>PharData</code> object is returned.
     *
     * @since PHP 5 >= 5.3.0, PHP 7, PECL phar >= 2.0.0
     *
