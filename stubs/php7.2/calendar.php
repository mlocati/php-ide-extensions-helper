 ...
 */
function easter_date(int $year = /* date("Y") */ null): int
{
}
 ...
 */
function easter_days(int $year = /* date("Y") */ null, int $method = CAL_EASTER_DEFAULT): int
{
}
 ...
 */
function unixtojd(int $timestamp = /* time() */ null): int
{
}
