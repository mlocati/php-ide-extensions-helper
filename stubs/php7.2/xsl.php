...
class XSLTProcessor
{
     ...
     * Import stylesheet
     *
     * @param object $stylesheet The imported style sheet as a <code>DOMDocument</code> or
     ...
     */
    public function setParameter(string $namespace, string $name, string $value = null): bool
    {
    }
     ...
     * Transform to XML
     *
     * @param object $doc The <code>DOMDocument</code> or <code>SimpleXMLElement</code> object to
     * be transformed.
     *
