<?php
// Documentation generated automatically for extension Core v7.1.4 with PHP v7.1.4
...
const FALSE = false;
const NULL = null;
const PEAR_EXTENSION_DIR = 'ext';
const PEAR_INSTALL_DIR = 'pear';
const PHP_BINARY = 'php.exe';
const PHP_BINDIR = 'php';
const PHP_CONFIG_FILE_PATH = 'php';
const PHP_CONFIG_FILE_SCAN_DIR = '';
const PHP_DATADIR = 'php';
const PHP_DEBUG = 0;
const PHP_EOL = "\r\n";
const PHP_EXTENSION_DIR = 'ext';
const PHP_EXTRA_VERSION = '';
const PHP_FD_SETSIZE = 256;
const PHP_INT_MAX = 2147483647;
const PHP_INT_MIN = -2147483648;
const PHP_INT_SIZE = 4;
const PHP_LIBDIR = 'php';
const PHP_LOCALSTATEDIR = 'php';
...
const PHP_SAPI = 'cli';
const PHP_SHLIB_SUFFIX = 'dll';
const PHP_SYSCONFDIR = 'php';
const PHP_VERSION = '7.1.4';
const PHP_VERSION_ID = 70104;
const PHP_WINDOWS_NT_DOMAIN_CONTROLLER = 2;
const PHP_WINDOWS_NT_SERVER = 3;
const PHP_WINDOWS_NT_WORKSTATION = 1;
const PHP_WINDOWS_VERSION_BUILD = 15063;
