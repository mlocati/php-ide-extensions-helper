 ...
 */
function cal_to_jd($calendar, $month, $day, $year): int
{
}
 ...
 */
function easter_date($year = null): int
{
}
 ...
 */
function easter_days($year = null, $method = null): int
{
}
 ...
 */
function frenchtojd($month, $day, $year): int
{
}
 ...
 */
function gregoriantojd($month, $day, $year): int
{
}
 ...
 */
function jdmonthname($juliandaycount, $mode): string
{
}
 ...
 */
function jdtofrench($juliandaycount): string
{
}
 ...
 */
function jdtogregorian($juliandaycount): string
{
}
 ...
 */
function jdtojewish($juliandaycount, $hebrew = null, $fl = null): string
{
}
 ...
 */
function jdtojulian($juliandaycount): string
{
}
 ...
 */
function jewishtojd($month, $day, $year): int
{
}
 ...
 */
function juliantojd($month, $day, $year): int
{
}
 ...
 */
function unixtojd($timestamp = null): int
{
}
